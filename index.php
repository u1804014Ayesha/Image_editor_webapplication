        ...
        <div ng-controller="MainController" ng-cloak style="height: 100%">
            ...
            <script type="application/ng-template" id="main-image-upload-dialog-template">
                ...
                <div class="buttons" ng-show="!canOpenImage">
                            <md-button ng-click="openImageMode = 'create'" class="md-primary" href="signup.php">Signup</md-button>
                            <md-button ng-click="openSampleImage()" href="login.php">Login</md-button>
                        </div>
                        </md-dialog>
            </script>
